...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default=f"./runs/collab/opinion/{group_size}", type=str)
    ...
    entropy_counts = entropy_dict(group_size)
    ...
    for ind, example in enumerate(examples):
        ...
        if not os.path.exists(save_path):
            ...
            chat.create_agents(example.names, example.labels, example.system_messages)
